...
variable "project_name" {
  type        = string
  description = "The name of the Azure Migrate project (optional, used for validation)"
...
variable "protected_item_id" {
  type        = string
  description = "The full resource ID of the protected item to migrate"
...
variable "shutdown_source_vm" {
  type        = bool
  description = "Whether to shutdown the source VM before migration (recommended for data consistency)"
  default     = true
}
